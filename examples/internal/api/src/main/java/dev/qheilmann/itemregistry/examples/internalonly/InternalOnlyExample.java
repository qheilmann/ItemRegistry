...
@NullMarked
public final class InternalOnlyExample extends JavaPlugin {

    public static final String NAMESPACE = "internal_only_example";
    ...
    public void onEnable() {
        ...
        int customItems = registry.getSources().stream()
            ...
            .mapToInt(s -> s.registeredKeys().size())
            .sum();
        getSLF4JLogger().info("InternalOnlyExample: enabled with {} sources, {} total items ({} custom).",
                                    totalSources, totalItems, customItems);
    }

    @Override
    public void onDisable() {
        getLogger().info("InternalOnlyExample disabled.");
    }
    ...
    * Sets up custom items in the PdcItemSource.
    ...
    private void addCustomItems(PdcItemSource source) {
        ...
        // Add the wand to the source under the key "internal_only_example:magic_wand"
